...
public class HeaderBitmapImage {
    ...
    short bitsCount;
    long compression;
    long sizeOfCompImage;
    long horizontalResolution;
    long verticalResolution;
    long numbOfUsedColors;
    long numbOfImportantColors;
    long halfOfWidth;
    ...
    public void setValues(short type, long size, short resF1, short resF2, long
            offs, long sHeader, long w, long h, short nColPan, short bCount, long compr,
                          long sComp, long hRes, long vRes, long nUsCol, long nImpCol, long half) {
        setType(type);
        setSize(size);
